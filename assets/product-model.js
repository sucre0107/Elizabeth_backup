class Product3DModel extends HTMLElement {
    constructor() {
        super();
        this.openModelModal();
    ...
    setupModelViewerUI() {
        if(errors) return;
        this.modelViewerUI = new Shopify.ModelViewerUI(document.querySelector('model-view'))
    }*/
...
const product3DModel = customElements.define('product-model', Product3DModel)